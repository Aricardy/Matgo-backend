...
export default function SosPage() {
  ...
  const content = {
    ENG: {
      ...
      sosActivatedDesc: "Emergency contacts and MatGo Safety Team have been notified (simulated). Help is on the way.",
      ...
      addContactDialogDesc: "This contact will be notified during an SOS (feature simulated).",
      nameLabel: "Name",
